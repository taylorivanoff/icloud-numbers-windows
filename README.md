...
iCloud Numbers desktop app for Windows. Loads [icloud.com/numbers](https://www.icloud.com/numbers) in a native **Tauri / WebView2** shell.
...
- **Deep link** — `icloud-numbers://` protocol handler
